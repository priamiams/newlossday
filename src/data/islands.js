export const islandsData = [
  {
    ...
    jalur: 'Penyeberangan laut Jepara – Karimun Jawa',
  ...
  },
  {
    ...
    jalur: 'Marina Ancol – Pulau Tujuan',
  ...
  },
  {
    ...
    title: 'Pulau Harapan',
    location: 'DKI Jakarta',
    image: '/img/pulau/pulauharapan.jpg',
    ...
    jalur: 'Muara Angke – Pulau Harapan',
    duration: '2 Hari 1 Malam / 3 Hari 2 Malam',
    rundown: [
      'Hari 1: Penyeberangan – Snorkeling – Sunset',
      'Hari 2: Island hopping – Free time – Kembali',
      '(Hari ke-3 opsional untuk paket 3H2M)'
    ],
    kuota: 'Min 4 – Max 17',
    jadwal: 'By Request',
    price: 'Mulai Rp 390.000 / orang',
